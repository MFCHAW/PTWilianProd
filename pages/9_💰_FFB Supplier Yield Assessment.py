...
if 'yieldassess_OERAverageUnitPrice_Detail' not in st.session_state:
    st.session_state['yieldassess_OERAverageUnitPrice_Detail'] = 0.00
            ...
            with st.container():
                ...
                with st.container():
                    with col23_2:
                        ...
                        st.number_input('OER (Average) (%)', key='yieldassess_OERBuying_Detail', disabled=True, format='%0.2f')

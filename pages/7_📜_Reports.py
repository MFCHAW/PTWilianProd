...
if comboBoxReport == 'FFB Reception & Pricing':
...
elif comboBoxReport == 'FFB Receipts Due For Payment':
    js = '''
    // Server Site (Function App) Url
    var getEmbedToken = "https://powerbisample-01.azurewebsites.net/api/HttpTriggerCSharp1?code=TY1xGH30Yxr0/W3SD/FJuvhHxIT0OfDbsLCjEL7Giky9lmx7NRTdYQ==";
    ...
    function previewReport() {
        $.ajax({
            url: getEmbedToken,
            data: { PBIE_GROUP_ID: '645a9f59-ea89-457e-9a5a-68832c747f5a', PBIE_REPORT_ID : '95f2abe2-aa12-402e-9545-9e489c597b98'},
            jsonpCallback: 'callback',
            contentType: 'application/javascript',
            dataType: "jsonp",
            success: function (json) {
    ...
    <html>
        <head>
            <meta http-equiv="Content-type" content="text/html; charset=utf-8">
            <meta name="viewport" content="width=device-width,initial-scale=1">
            <title>FFB Receipts Due For Payment</title>
            <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
            <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
            <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
            <script type="text/javascript" language="javascript" src="https://code.jquery.com/jquery-1.12.4.js"></script>
